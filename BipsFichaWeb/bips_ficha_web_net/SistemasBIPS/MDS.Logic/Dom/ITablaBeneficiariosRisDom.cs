...
{
    /// <summary>
	/// interfaz de cb_beneficiarios_ris dom
	/// </summary>
    public partial interface ITablaBeneficiariosRisDom
    {
        /// <summary>
        ...
        /// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>        
        ViewDto<TablaBenefiariosRisDto> Registrar(ContextoDto p_Contexto, TablaBenefiariosRisDto p_Datos, EnumAccionRealizar p_Accion);
    }
}

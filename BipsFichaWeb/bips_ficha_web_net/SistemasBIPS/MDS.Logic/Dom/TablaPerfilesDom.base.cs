...
{
    /// <summary>
	///	Clase de cb_perfiles dom
	/// </summary>
    public partial class TablaPerfilesDom : ITablaPerfilesDom
    {
        ...
        /// </summary>
        public ITablaPerfilesDao iTablaPerfilesDao;
        #endregion
        ...
        public TablaPerfilesDom()
        {
            ...
            iTablaPerfilesDao = (ITablaPerfilesDao)Activator.CreateInstance(typeof(TablaPerfilesDao));
        }
        #endregion
		...
		public ViewDto<TablaPerfilesDto> Buscar(ContextoDto p_Contexto, TablaPerfilesFiltroDto p_Filtro)
        {
            ViewDto<TablaPerfilesDto> viewResponse = new ViewDto<TablaPerfilesDto>();
            try
            {
                AssertNull.NotNullOrEmpty(p_Filtro);
                viewResponse = iTablaPerfilesDao.Buscar(p_Contexto, p_Filtro);

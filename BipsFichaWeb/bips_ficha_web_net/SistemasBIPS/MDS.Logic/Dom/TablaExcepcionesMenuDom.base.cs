...
{
    /// <summary>
	///	Clase de cb_excepciones_menu dom
	/// </summary>
    public partial class TablaExcepcionesMenuDom : ITablaExcepcionesMenuDom
    {
        ...
        /// </summary>
        public ITablaExcepcionesMenuDao iTablaExcepcionesMenuDao;
        #endregion
        ...
        /// </summary>
        public TablaExcepcionesMenuDom()
        {
            ...
            iTablaExcepcionesMenuDao = (ITablaExcepcionesMenuDao)Activator.CreateInstance(typeof(TablaExcepcionesMenuDao));
        }
        #endregion
		...
		public ViewDto<TablaExcepcionesMenuDto> Buscar(ContextoDto p_Contexto, TablaExcepcionesMenuFiltroDto p_Filtro)
        {
            ...
            try
            {
                ...
                viewResponse = iTablaExcepcionesMenuDao.Buscar(p_Contexto, p_Filtro);

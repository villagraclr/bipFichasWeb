...
{
    /// <summary>
	///	Clase de cb_menu_formularios dom
	/// </summary>
    public partial class TablaMenuFormulariosDom : ITablaMenuFormulariosDom
    {
        ...
        /// </summary>
        public ITablaMenuFormulariosDao iMenuFormulariosDao;
        #endregion
        ...
        /// </summary>
        public TablaMenuFormulariosDom()
        {
            ...
            iMenuFormulariosDao = (ITablaMenuFormulariosDao)Activator.CreateInstance(typeof(TablaMenuFormulariosDao));
        }
        #endregion
		...
		public ViewDto<TablaMenuFormulariosDto> Buscar(ContextoDto p_Contexto, TablaMenuFormulariosFiltroDto p_Filtro)
        {
            ...
            try
            {
                ...
                viewResponse = iMenuFormulariosDao.Buscar(p_Contexto, p_Filtro);

...
{
    /// <summary>
	///	Clase de programas usuarios mgr
	/// </summary>
    public partial class SistemasBIPSMgr : ITablaProgramasUsuariosMgr
    {
        #region campos publicos
        /// <summary>
        /// campo publico que contiene una instancia del objeto de negocio 
        /// </summary>
        private ITablaProgramasUsuariosDom iTablaProgramasUsuariosDom;
        #endregion
        ...
        public ViewDto<TablaProgramasDto> BuscarProgramasUsuarios(ContextoDto p_Contexto, TablaProgramasFiltroDto p_Filtro)
        {
            ViewDto<TablaProgramasDto> viewResponse = new ViewDto<TablaProgramasDto>();
            try
            {
                viewResponse = iTablaProgramasUsuariosDom.Buscar(p_Contexto, p_Filtro);
        ...
        /// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>        
        public ViewDto<TablaFormulariosUsuariosDto> RegistrarFormulariosUsuarios(ContextoDto p_Contexto, TablaFormulariosUsuariosDto p_Datos, EnumAccionRealizar p_Accion)
        {
            ViewDto<TablaFormulariosUsuariosDto> viewResponse = new ViewDto<TablaFormulariosUsuariosDto>();
            try
            {
                viewResponse = iTablaProgramasUsuariosDom.Registrar(p_Contexto, p_Datos, p_Accion);
                if (viewResponse.HasError())
                {
                    //TODO: Generar error con especificacion de mensaje de proceso defectuoso
                    iProviderError.LoadError(ref viewResponse, EnumErrores.BLL_ERROR_GENERICO_PROCESO);

...
namespace MDS.Logic.Mgr
{
	...
	/// </summary>
    public partial class SistemasBIPSMgr : ITablaPreguntasTablasMgr
    {
        #region campos publicos
        /// <summary>
        /// campo publico que contiene una instancia del objeto de negocio 
        /// </summary>
        private ITablaPreguntasTablasDom iTablaPreguntasTablasDom;
        #endregion
        ...
        public ViewDto<TablaPreguntasTablasDto> BuscarPreguntasTablas(ContextoDto p_Contexto, TablaPreguntasTablasFiltroDto p_Filtro)
        {
            ViewDto<TablaPreguntasTablasDto> viewResponse = new ViewDto<TablaPreguntasTablasDto>();
            try
            {
                viewResponse = iTablaPreguntasTablasDom.Buscar(p_Contexto, p_Filtro);

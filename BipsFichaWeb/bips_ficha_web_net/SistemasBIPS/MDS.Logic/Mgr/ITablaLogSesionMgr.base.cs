...
{
    /// <summary>
	/// interfaz de log sesion mgr
	/// </summary>
    public partial interface ITablaLogSesionMgr
    {
        /// <summary>
        ...
        ViewDto<TablaLogSesionDto> RegistrarLogSesion(ContextoDto p_Contexto, TablaLogSesionDto p_Datos, EnumAccionRealizar p_Accion);
    }
}

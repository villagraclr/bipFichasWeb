...
(/** @lends <global> */function( $ ) {
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		...
		for ( var i=0 ; i<aDom.length ; i++ )
		{
			...
			{
				/* Length */
			    featureNode = _fnFeatureHtmlFilter(oSettings);//_fnFeatureHtmlLength( oSettings );
			}
			else if ( cOption == 'f' && features.bFilter )
			{
				/* Filter */
			    featureNode = _fnFeatureHtmlLength( oSettings );//_fnFeatureHtmlFilter( oSettings );
			}
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var span = '<span id="' + tableId + '_spFiltro" class="input-group-btn"></span>';
		...
		var filter = $('<div/>', {
				...
				'class': "form-group input-group",//classes.sFilter
				'style': "width: 100%"
			} )
            .append(str);

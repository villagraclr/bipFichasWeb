...
{
    /// <summary>
    /// Clase representativa de la tabla CB_PREGUNTAS_FORMULARIOS
    /// </summary>
    public partial class TablaPreguntasFormulariosDto : ICloneable
    {
        ...
        /// </summary>
        /// <remarks>miembro de la clave primaria de la tabla B_PREGUNTAS_FORMULARIOS</remarks>
        ...
        /// </summary>
        public TablaPreguntasFormulariosDto()
        {
        }
        #endregion
        ...
        public Object Clone()
        {
            TablaPreguntasFormulariosDto objDto = (TablaPreguntasFormulariosDto)this.MemberwiseClone();
            return objDto;
        }
        #endregion
    }

...
{
    /// <summary>
	/// interfaz de cb_log_formularios dom
	/// </summary>
    public partial interface ITablaLogFormulariosDom
    {
        /// <summary>
        ...
        /// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>        
        ViewDto<TablaLogFormulariosDto> Registrar(ContextoDto p_Contexto, TablaLogFormulariosDto p_Datos, EnumAccionRealizar p_Accion);
    }
}

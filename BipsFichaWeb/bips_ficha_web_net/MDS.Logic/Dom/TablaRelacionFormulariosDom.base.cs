...
{
    /// <summary>
	///	Clase de cb_relacion_formularios dom
	/// </summary>
    public partial class TablaRelacionFormulariosDom : ITablaRelacionFormulariosDom
    {
        ...
        /// </summary>
        public ITablaRelacionFormulariosDao iTablaRelacionFormulariosDao;
        #endregion
        ...
        /// </summary>
        public TablaRelacionFormulariosDom()
        {
            ...
            iTablaRelacionFormulariosDao = (ITablaRelacionFormulariosDao)Activator.CreateInstance(typeof(TablaRelacionFormulariosDao));
        }
        #endregion
		...
		public ViewDto<TablaRelacionFormulariosDto> Buscar(ContextoDto p_Contexto, TablaRelacionFormulariosFiltroDto p_Filtro)
        {
            ...
            try
            {
                ...
                viewResponse = iTablaRelacionFormulariosDao.Buscar(p_Contexto, p_Filtro);
		...
		/// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>
		public ViewDto<TablaRelacionFormulariosDto> Registrar(ContextoDto p_Contexto, TablaRelacionFormulariosDto p_Datos, EnumAccionRealizar p_Accion)
        {
            ViewDto<TablaRelacionFormulariosDto> viewResponse = new ViewDto<TablaRelacionFormulariosDto>();
            try
            {
                ...
                switch (p_Accion)
                {
                    ...
                    case EnumAccionRealizar.Insertar:
                        viewResponse = iTablaRelacionFormulariosDao.Insertar(p_Contexto, p_Datos);
                        break;                    
                    default:
                        break;
                }

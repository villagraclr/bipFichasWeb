...
{
    /// <summary>
    /// Clase encargada de la gestion de informacion del objeto CB_PLANTILLAS_TRASPASO
    /// </summary>
    public partial class TablaPlantillasTraspasoDao : ITablaPlantillasTraspasoDao
    {
        ...
        /// </summary>
        public TablaPlantillasTraspasoDao()
        {
		...
		/// </summary>
		/// <param name="p_Dr">registro con informacion del objeto CB_PLANTILLAS_TRASPASO obtenido</param>
		/// <returns>dto conformado en base a la informacion entregada</returns>
		private TablaPlantillasTraspasoDto Create(IDataReader p_Dr)
        {
            TablaPlantillasTraspasoDto vObj = new TablaPlantillasTraspasoDto();
            try
            {
                vObj.IdPlantillaTraspaso = (p_Dr["ID_PLANTILLA_TRASPASO"] is DBNull) ? (Nullable<Decimal>)null : (Nullable<Decimal>)p_Dr["ID_PLANTILLA_TRASPASO"];               
                ...
                vObj.TipoFormularioOrigen = (p_Dr["TIPO_FORMULARIO_ORIGEN"] is DBNull) ? (Nullable<Decimal>)null : (Nullable<Decimal>)p_Dr["TIPO_FORMULARIO_ORIGEN"];                
                vObj.TipoFormularioDestino = (p_Dr["TIPO_FORMULARIO_DESTINO"] is DBNull) ? (Nullable<Decimal>)null : (Nullable<Decimal>)p_Dr["TIPO_FORMULARIO_DESTINO"];                
		...
		/// <param name="p_Datos">objeto en el cual se cargara la informacion</param>
		/// <returns>view dto conformado en base a la informacion entregada</returns>
		private void CreateViewDto(OracleDataReader p_Dr, ref ViewDto<TablaPlantillasTraspasoDto> p_Respuestas)
        {
            ...
            List<TablaPlantillasTraspasoDto> listDto = new List<TablaPlantillasTraspasoDto>();
            if (p_Dr != null)
            {
                while (p_Dr.Read())
                {
            ...
            if (listDto.Count > 0)
            {
                p_Respuestas = new ViewDto<TablaPlantillasTraspasoDto>(listDto);
            }
        }
        #endregion
        ...
        public ViewDto<TablaPlantillasTraspasoDto> Buscar(ContextoDto p_Contexto, TablaPlantillasTraspasoFiltroDto p_Filtro)
        {
            ...
            try
            {
                ...
                dbCommand.CommandText = "PCKCBPLANTILLASTRASPASO.prcBuscar";
                dbCommand.Parameters.Add(new OracleParameter() { OracleDbType = OracleDbType.Decimal, ParameterName = "p_ID_PLANTILLA_TRASPASO", Direction = ParameterDirection.Input, Value = p_Filtro.IdPlantillaTraspaso });
                dbCommand.Parameters.Add(new OracleParameter() { OracleDbType = OracleDbType.Decimal, ParameterName = "p_TIPO_FORMULARIO_ORIGEN", Direction = ParameterDirection.Input, Value = p_Filtro.TipoFormularioOrigen });
                dbCommand.Parameters.Add(new OracleParameter() { OracleDbType = OracleDbType.Decimal, ParameterName = "p_TIPO_FORMULARIO_DESTINO", Direction = ParameterDirection.Input, Value = p_Filtro.TipoFormularioDestino });

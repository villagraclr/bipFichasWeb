...
{
    /// <summary>
	///	Clase de cb_funciones_dependencias dom
	/// </summary>
    public partial class TablaFuncionesDependenciasDom : ITablaFuncionesDependenciasDom
    {
        ...
        /// </summary>
        public ITablaFuncionesDependenciasDao iFuncionesDependenciasDao;
        #endregion
        ...
        /// </summary>
        public TablaFuncionesDependenciasDom()
        {
            ...
            iFuncionesDependenciasDao = (ITablaFuncionesDependenciasDao)Activator.CreateInstance(typeof(TablaFuncionesDependenciasDao));
        }
        #endregion
		...
		public ViewDto<TablaFuncionesDependenciasDto> Buscar(ContextoDto p_Contexto, TablaFuncionesDependenciasFiltroDto p_Filtro)
        {
            ...
            try
            {
                ...
                viewResponse = iFuncionesDependenciasDao.Buscar(p_Contexto, p_Filtro);

...
{
    /// <summary>
	/// interfaz de parametros mgr
	/// </summary>
    public partial interface ITablaParametrosMgr
    {
        /// <summary>
        ...
        ViewDto<TablaParametrosDto> BuscarParametros(ContextoDto p_Contexto, TablaParametrosFiltroDto p_Filtro);
        ...
        /// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>        
        ViewDto<TablaParametrosDto> RegistrarParametros(ContextoDto p_Contexto, TablaParametrosDto p_Parametros, EnumAccionRealizar p_Accion);
    }
}

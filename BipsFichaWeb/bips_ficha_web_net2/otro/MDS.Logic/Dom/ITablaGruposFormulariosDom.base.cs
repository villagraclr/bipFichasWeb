...
{
    /// <summary>
	/// interfaz de cb_grupos_formularios dom
	/// </summary>
    public partial interface ITablaGruposFormulariosDom
    {
        /// <summary>
		...
		/// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>
		ViewDto<TablaGruposFormulariosDto> Registrar(ContextoDto p_Contexto, TablaGruposFormulariosDto p_Datos, EnumAccionRealizar p_Accion);
    }
}

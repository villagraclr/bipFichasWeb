...
namespace MDS.Logic.Mgr
{
    public partial interface ITablaExcepcionesPreguntasMgr
    {
        ...
        /// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>        
        ViewDto<TablaExcepcionesPermisosDto> RegistrarExcepcionesFormularios(ContextoDto p_Contexto, TablaExcepcionesPermisosDto p_Datos, EnumAccionRealizar p_Accion);
        ...
        /// <param name="p_Filtro">informacion de filtrado para realizar la busqueda</param>
        /// <returns>objeto contenedor de la informacion generada por la accion ejecutada</returns>	
        ViewDto<TablaExcepcionesPlantillasFormDto> BuscarExcepcionesPlantilla(ContextoDto p_Contexto, TablaExcepcionesPlantillasFormDto p_Filtro);
    }
}

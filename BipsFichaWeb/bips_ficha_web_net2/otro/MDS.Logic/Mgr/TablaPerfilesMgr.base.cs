...
{
    /// <summary>
	///	Clase de perfiles mgr
	/// </summary>
    public partial class SistemasBIPSMgr : ITablaPerfilesMgr
    {
        #region campos publicos
        /// <summary>
        /// campo publico que contiene una instancia del objeto de negocio 
        /// </summary>
        private ITablaPerfilesDom iTablaPerfilesDom;
        #endregion
        ...
        public ViewDto<TablaPerfilesDto> BuscarPerfiles(ContextoDto p_Contexto, TablaPerfilesFiltroDto p_Filtro)
        {
            ViewDto<TablaPerfilesDto> viewResponse = new ViewDto<TablaPerfilesDto>();
            try
            {
                viewResponse = iTablaPerfilesDom.Buscar(p_Contexto, p_Filtro);
